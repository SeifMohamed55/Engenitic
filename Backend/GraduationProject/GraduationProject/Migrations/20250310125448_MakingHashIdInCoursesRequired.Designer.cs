...
namespace GraduationProject.Migrations
{
    ...
    [Migration("20250310125448_MakingHashIdInCoursesRequired")]
    partial class MakingHashIdInCoursesRequired
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GraduationProject.Models.FileHash", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AppUserFileHash", b =>
                {
                    b.HasOne("GraduationProject.Models.FileHash", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CourseTag", b =>
                {
                    b.HasOne("GraduationProject.Models.Course", null)
                        .WithMany()
                        .HasForeignKey("CoursesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GraduationProject.Models.Tag", null)
                        .WithMany()
