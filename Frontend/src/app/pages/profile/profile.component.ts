...
export class ProfileComponent implements OnInit, OnDestroy{
    ...
    ngOnInit(): void {
      this._UserService.userId.pipe(takeUntil(this.destroy$)).subscribe(id => {
        if (id) {
          this.userData.id = id;
    ...
    initiateForms() : void {
      this._UserService.getProfileData(this.userData.id).pipe(takeUntil(this.destroy$)).subscribe({
        next : res => {
          console.log(res);
